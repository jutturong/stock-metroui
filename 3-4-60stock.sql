...
--
-- Host: localhost
-- Generation Time: Apr 09, 2017 at 09:27 AM
...
INSERT INTO `tb_product` (`id_product`, `product_name`, `code_product`, `name_product`, `brand_product`, `number_product`, `price_product`, `description_product`) VALUES
(1, 'PRD_cpacmonier_prakaitong1.jpg', '', 'กระเบื้องหลังคาซีแพคโมเนีย ตราช้าง สีประกายกาญจน์ (BULLION FLASHED)', 'ตราช้าง', 5, 13.82, 'กลุ่มสีคอนแทรซ(Contrazz)....2อารมณ์สีสวย...ไม่ซ้ำใคร เมื่อความเข้มขรึมสาดเข้าหาความร้อนแรงด้วยจังหวะที่กลมกลืนก่อกำเนิดอารมณ์สีสวยโดดเด่นที่ผสานในแผ่นเดียว กระเบื้องหลังคาซีแพคโมเนีย ตราช้าง คอนแทรซ.. ศิลปะแห่งสีสันบนผืนหลังคาที่สวยไม่ซ้ำผืน ไม่ซ้ำใครน้ำหนักกระเบื้องหลังคาซีแพคโมเนีย ตราช้าง (โดยประมาณ) -ต่อแผ่น : 4.05 กิโลกรัม -ระยะแป 34 เซนติเมตร : 39.70 ก.ก/ตร.ม. -ระยะแป 32 เซนติเมตร : 42.20 ก.ก/ตร.ม. -ต่อ 1,000 แผ่น : 4.05 ตัน');
