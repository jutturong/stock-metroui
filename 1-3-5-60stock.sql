...
--
-- Host: localhost
-- Generation Time: May 03, 2017 at 09:59 AM
...
INSERT INTO `tb_billing` (`id_billing`, `id_member`, `id_product`, `prices`, `timerecord`) VALUES
(7, 1, 2, 3, '2017-04-30 22:09:00'),
(8, 1, 8, 4, '2017-04-30 22:09:00'),
(9, 1, 2, 3, '2017-05-01 17:52:00'),
(10, 1, 4, 3, '2017-05-01 17:52:00'),
(11, 1, 2, 3, '2017-05-01 17:22:00'),
(12, 1, 4, 3, '2017-05-01 17:22:00'),
(13, 1, 2, 3, '2017-05-01 17:13:00'),
(14, 1, 4, 3, '2017-05-01 17:13:00'),
(15, 1, 2, 3, '2017-05-01 17:35:00'),
(16, 1, 4, 3, '2017-05-01 17:35:00'),
(17, 1, 2, 3, '2017-05-01 17:27:00'),
(18, 1, 4, 3, '2017-05-01 17:27:00'),
(19, 1, 2, 3, '2017-05-01 17:26:00'),
(20, 1, 4, 2, '2017-05-01 17:26:00'),
(21, 1, 2, 3, '2017-05-01 17:56:00'),
(22, 1, 4, 2, '2017-05-01 17:56:00'),
(23, 1, 2, 2, '2017-05-01 17:24:00'),
(24, 1, 4, 3, '2017-05-01 17:24:00'),
(25, 1, 2, 2, '2017-05-01 17:47:00'),
(26, 1, 4, 3, '2017-05-01 17:47:00'),
(27, 1, 4, 2, '2017-05-01 17:05:00'),
(28, 1, 4, 2, '2017-05-01 17:22:00'),
(29, 1, 8, 4, '2017-05-01 17:22:00'),
(30, 1, 4, 2, '2017-05-01 17:11:00'),
(31, 1, 8, 4, '2017-05-01 17:11:00'),
(32, 1, 2, 1, '2017-05-02 22:14:00'),
(33, 1, 2, 1, '2017-05-02 22:57:00'),
(34, 1, 2, 1, '2017-05-02 22:31:00'),
(35, 1, 6, 1, '2017-05-02 22:31:00'),
(36, 1, 2, 1, '2017-05-02 22:49:00'),
(37, 1, 6, 1, '2017-05-02 22:49:00'),
(38, 1, 2, 2, '2017-05-03 08:13:00'),
(39, 1, 8, 2, '2017-05-03 08:13:00'),
(40, 1, 2, 2, '2017-05-03 08:28:00'),
(41, 1, 8, 2, '2017-05-03 08:28:00'),
(42, 1, 2, 2, '2017-05-03 08:59:00'),
(43, 1, 8, 2, '2017-05-03 08:59:00'),
(44, 1, 2, 2, '2017-05-03 08:01:00'),
(45, 1, 8, 2, '2017-05-03 08:01:00'),
(46, 1, 2, 2, '2017-05-03 08:44:00'),
(47, 1, 8, 2, '2017-05-03 08:44:00'),
(48, 1, 2, 2, '2017-05-03 08:58:00'),
(49, 1, 8, 2, '2017-05-03 08:58:00'),
(50, 1, 2, 2, '2017-05-03 08:15:00'),
(51, 1, 8, 2, '2017-05-03 08:15:00'),
(52, 1, 2, 2, '2017-05-03 08:35:00'),
(53, 1, 8, 2, '2017-05-03 08:35:00'),
(54, 1, 2, 2, '2017-05-03 08:52:00'),
(55, 1, 8, 2, '2017-05-03 08:52:00'),
(56, 1, 2, 2, '2017-05-03 08:15:00'),
(57, 1, 8, 2, '2017-05-03 08:15:00'),
(58, 1, 2, 2, '2017-05-03 08:49:00'),
(59, 1, 8, 2, '2017-05-03 08:49:00'),
(60, 1, 2, 2, '2017-05-03 08:08:00'),
(61, 1, 8, 2, '2017-05-03 08:08:00'),
(62, 1, 2, 2, '2017-05-03 08:33:00');
...
(1, 'admin', '81dc9bdb52d04dc20036dbd8313ed055', 'jutturong', 'charoenrit', 1, 1, 1, -16969),
...
(2, 1, '015.gif', 'S0041', 'เหล็กข้ออ้อย SD-40, 20 มิล 24.66kg ( โรงใหญ่ )', '-', 59, 599, 'เหล็กข้ออ้อย SD-40, 20 มิล 24.66kg ( โรงใหญ่ )'),
...
(6, 4, 'pd320748.jpg', '8852404046502', 'ครอบ 4 ทาง ไฟเบอร์ซีเมนต์ เอสซีจี รุ่นไอยร่า30องศา เนเชอรัลบริค', 'SCG', 86, 100, 'วัสดุ : ไฟเบอร์ซีเมนต์ \nขนาดสินค้า\nความกว้าง : 41 ซม.\nความยาว : 41 ซม.\nน้ำหนัก : 1.4 กก.\nข้อมูลอื่นๆ\nจำนวนการใช้งาน : 1 แผ่น/จุด'),
...
(13, 9, '105415_L.jpg', 'A240388', 'ทินเนอร์ JOTUN #2 15L', 'TOA', 5, 400, 'ทินเนอร์ JOTUN #2 5L\n\nช่วยลดการแห้งตัวอย่างรวดเร็วของสีรองพื้น\nใช้ล้างแปรงและอุปกรณ์ทาสีได้\nยึดเกาะดีเยี่ยม\nฟิล์มสีทนนานไม่ซีดจาง\nช่วยแทรกซึมลึกเข้าเนื้อวัสดุได้ดี\n\nวัสดุ:	THINNER\nกว้าง:	16.6 ซม.\nสี:	ใส\nน้ำหนัก:	5 กก.\nสูง:	33.8 ซม.\nลึก:	16.6 ซม.\nรหัส:	#2\nการใช้งาน:	ENAMEL');
...
--
ALTER TABLE `tb_billing`
  MODIFY `id_billing` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=63;
--
