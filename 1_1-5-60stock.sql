...
--
-- Host: localhost
-- Generation Time: May 01, 2017 at 10:08 AM
...
(2, 1, '015.gif', 'S0041', 'เหล็กข้ออ้อย SD-40, 20 มิล 24.66kg ( โรงใหญ่ )', '-', 3, 599, 'เหล็กข้ออ้อย SD-40, 20 มิล 24.66kg ( โรงใหญ่ )'),
...
--
ALTER TABLE `tb_billing`
  MODIFY `id_billing` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=19;
--
