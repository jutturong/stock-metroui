                ...
                <div class="row cells2">
                    <div class="cell">
                        <div class="row cells4">
                            <div class="cell">
                                <img src="<?=base_url()?>node_modules/metro-ui/docs/images/spface2.jpg" data-role="fitImage" data-format='square' data-type='bordered' data-shadow="false">
                            </div>
                            <div class="cell colspan3 padding20 no-padding-top no-padding-bottom">
                                ...
                                <div>
                                    <a href="https://www.jetbrains.com/phpstorm/" title="license for PhpStorm"><img src="<?=base_url()?>node_modules/metro-ui/docs/images/jetbrains.png" style="width: 100px" ></a>
                                    <a href="http://www.microsoft.com/bizspark/default.aspx" title="Bizspark Startup"><img src="<?=base_url()?>node_modules/metro-ui/docs/images/MSFT_logo_png.png" style="width: 100px" ></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="cell">
                        <div class="row cells4">
                            <div class="cell">
                                <img src="<?=base_url()?>node_modules/metro-ui/docs/images/zadorozhnyi.jpg" data-role="fitImage" data-format='square' data-type='bordered' data-shadow="false">
                            </div>
                            <div class="cell colspan3 padding20 no-padding-top no-padding-bottom">
                                <h3>Co-Founder:</h3>
                                <p class="text-secondary">
